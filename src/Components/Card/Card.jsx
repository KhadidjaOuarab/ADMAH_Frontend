...
import Input from "../Input/InputNew";
...
function Card() {
  ...
  const loginFunction = (e) => {
    ...
    console.log("111111111111111111111111111111111111");
    axios
      .post("http://192.168.1.36:4000/Users/login", user)
      .then((response) => {
  ...
  return (
    <div className="Card">
      ...
      <div>
        <Input label="User Name" val1={username} setVal1={getValueUsername} />
      </div>
      <div>
        <InputPass value13={password} setValue13={getValuePassword} />
      </div>
